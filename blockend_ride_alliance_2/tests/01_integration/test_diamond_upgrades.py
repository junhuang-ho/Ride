...
def test_diamond_add(ride_cut, ride_loupe, dBox5, deployer):
...
def test_diamond_remove(ride_cut, ride_loupe, dBox5, deployer):
    test_diamond_add(ride_cut, ride_loupe, dBox5, deployer)
...
def test_diamond_remove_partial(ride_cut, ride_loupe, dBox5, deployer):
    test_diamond_add(ride_cut, ride_loupe, dBox5, deployer)
...
def test_diamond_remove_partial_then_remaining(ride_cut, ride_loupe, dBox5, deployer):
    # note: facet address should be removed after removing remaining as well
    test_diamond_remove_partial(ride_cut, ride_loupe, dBox5, deployer)
...
def test_diamond_add_then_remove(ride_cut, ride_loupe, dBox5, dBox6, deployer):
...
def test_diamond_state_persists_read(
    ride_hub, ride_cut, ride_loupe, dBox5, dBox6, Box5, Box6, Contract, deployer
):
    value = 5
