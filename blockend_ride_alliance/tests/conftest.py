...
import scripts.deploy_ride_alliance_factory as deploy_ride_alliance_factory
...
@pytest.fixture(scope="module", autouse=True)
def ride_alliance_factory(deployer):
    yield deploy_ride_alliance_factory.main(deployer)


@pytest.fixture(scope="module", autouse=True)
def ride_alliance_forger(ride_alliance_factory, RideAllianceForger, Contract, deployer):
    yield Contract.from_abi(
        "RideAllianceForger",
        ride_alliance_factory.address,
        RideAllianceForger.abi,
        deployer,
    )
...
def ride_alliance_access_control(
    ride_alliance_factory, RideAllianceAccessControl, Contract, deployer
):
    yield Contract.from_abi(
        "RideAllianceAccessControl",
        ride_alliance_factory.address,
        RideAllianceAccessControl.abi,
        deployer,
    )


@pytest.fixture(scope="module", autouse=True)
def ride_alliance_cut(ride_alliance_factory, RideAllianceCut, Contract, deployer):
    yield Contract.from_abi(
        "RideAllianceCut", ride_alliance_factory.address, RideAllianceCut.abi, deployer,
    )


@pytest.fixture(scope="module", autouse=True)
def ride_alliance_loupe(ride_alliance_factory, RideAllianceLoupe, Contract, deployer):
    yield Contract.from_abi(
        "RideAllianceLoupe",
        ride_alliance_factory.address,
        RideAllianceLoupe.abi,
        deployer,
    )
