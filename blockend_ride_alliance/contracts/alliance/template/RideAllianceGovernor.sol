...
contract RideAllianceGovernor is
    Governor,
    GovernorSettings,
    ...
    GovernorTimelockControl
{
    ...
    // TODO: set only drivers can vote

    modifier onlyAlly() {
        require(
            RideDriverDetails(rideHub)
                .getDriverToDriverDetails(msg.sender)
                .alliance == timelockAddress,
            "RideAllianceGovernor: caller not ally"
        );
        _;
    }
    ...
    ) public virtual override(Governor, IGovernor) onlyAlly returns (uint256) {
