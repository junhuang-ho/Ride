...
import "../../../alliance/facets/core/RideAllianceForger.sol";
import "../../../alliance/libraries/core/RideLibAllianceForger.sol";
...
contract RideTestAllianceForger is RideAllianceForger {
    ...
    function ssAllianceKeyToAlliance_(bytes32 _key, address _address) external {
        RideLibAllianceForger._storageAllianceForger().allianceKeyToAlliance[
                _key
            ] = _address;
    }
