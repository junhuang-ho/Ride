...
def test_giveRating(ride_rater, ride_badge, person1):
    assert ride_badge.sDriverToDriverReputation_(person1)[6] == 0
    assert ride_badge.sDriverToDriverReputation_(person1)[7] == 0

    tx = ride_rater.giveRating_(person1, 3)
    tx.wait(1)

    assert ride_badge.sDriverToDriverReputation_(person1)[6] == 3
    assert ride_badge.sDriverToDriverReputation_(person1)[7] == 1
