...
//             contractRideBadgeO = await ethers.getContractAt('IRideBadge', rideHubAddress, admin)
//             contractRideCurrencyRegistryO = await ethers.getContractAt('IRideCurrencyRegistry', rideHubAddress, admin)
//             contractRideExchangeO = await ethers.getContractAt('IRideExchange', rideHubAddress, admin)
//             contractRideHoldingO = await ethers.getContractAt('IRideHolding', rideHubAddress, admin)
//             contractRideTicketO = await ethers.getContractAt('IRideTicket', rideHubAddress, admin)
//             contractRidePenaltyO = await ethers.getContractAt('IRidePenalty', rideHubAddress, admin)
//             contractWETH9O = await ethers.getContractAt('WETH9', wETH9Address, admin)
...
//             sendAmountInETH = "0.01"
//             approveAmountInWETH = "0.01"
//             estimatedMinutes = 2
//             estimatedMetres = 100
//         })
