    ...
    describe("RideLibTicket", function ()
    {
        ...
        describe("_cleanUp", function ()
        {
            it("Should remove user to ticket, ticket and driver end data", async function ()
            {
                ...
                expect((await contractRideTicket.sTixIdToTicket_(tixId)).cancellationFee).to.equal(4)
                ...
                expect((await contractRideTicket.sTixIdToTicket_(tixId)).cancellationFee).to.equal(0)
    ...
    describe("RideTicket", function ()
    {
        ...
        describe("getTixIdToTicket", function ()
        {
            it("Should get ticket details", async function ()
            {
                ...
                expect((await contractRideTicket.getTixIdToTicket(tixId)).cancellationFee).to.equal(4)
